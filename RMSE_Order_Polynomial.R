...
set.seed(10)
train_list = sample(1:nrow(train_set), 50)
...
plot(order_list, test_error_list, pch = 19, cex = 0.5, 
     xlab = "Order Of Polynomial", ylab = "Test RMSE Value",
     main = "RMSE Vs Order Of Polynomial For 4 Different
     Samples Of Same Size (n = 150) ")
